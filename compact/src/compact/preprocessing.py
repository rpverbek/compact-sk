...
def _transform_orders_and_bin(data_healthy_train, f, recompute=False):
...
def _normalize_orders(df_orders_train, recompute=False):
...
def get_and_preprocess_healthy_data(recompute=False):
    ...
    df_orders_train, meta_data_train = _transform_orders_and_bin(data_healthy_train, f, recompute)
    df_V_train = _normalize_orders(df_orders_train, recompute)
